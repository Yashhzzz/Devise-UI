  ...
  return (
    <Layout>
      ...
      <section className="relative overflow-hidden pt-32 pb-24 px-6">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <div className="flex flex-wrap gap-4 justify-center mt-8">
            <button className="bg-brand-orange text-white rounded-full px-6 py-2.5 font-medium hover:bg-orange-600 transition-colors shadow-lg shadow-brand-orange/20">
              Book a Demo
            </button>
      ...
      <section className="mx-6 md:mx-auto max-w-5xl rounded-2xl bg-brand-navy text-white py-16 px-8 mb-24 text-center">
        ...
        <button className="bg-brand-orange text-white rounded-full px-8 py-3 font-semibold hover:bg-orange-600 transition-colors shadow-lg shadow-brand-orange/20">
          Book a Demo
        </button>
      </section>
    </Layout>
