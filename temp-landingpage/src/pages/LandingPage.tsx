      ...
      <section className="relative pt-32 pb-24 px-6 bg-transparent">
        ...
        <div className="max-w-4xl mx-auto text-center relative" style={{ zIndex: 1 }}>
          ...
          <div className="flex flex-wrap gap-4 justify-center mt-8">
            ...
            <button className="bg-brand-orange text-white rounded-full px-6 py-2.5 font-medium hover:bg-orange-600 transition-colors shadow-lg shadow-brand-orange/20 flex items-center gap-2">
